...
public class searchInLL {
    ...
    public int search(int key){ // iterative way
        int i = 0;
        Node temp = head;
        while(temp != null){
            if(temp.data == key){
    ...
    public int searchRecursive(Node head, int key){ // recursive way
    ...
    public static void main(String[] args) {
        ...
        int k = sc.nextInt();
        System.out.println(ll.search(k));
        System.out.println(ll.searchRecursive(head,k));
    }
}
