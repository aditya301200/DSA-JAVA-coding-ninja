...
/*
Problem Statement: Push Zeros to end
...
Another important fact is that the order of the non-zero elements have been maintained
as they appear in the input array/list.
...
public class PushZeroToEnd {
    private static void pushZero(int[] arr, int n) {
        int i=0;
        int j= n-1;
        while(i<=j) {
            if(arr[i]==0 && arr[j]!=0) {
