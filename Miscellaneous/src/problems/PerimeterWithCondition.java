...
/*
Problem Statement: Perimeter with conditions
Problem Level: EASY
Problem Description:
Aahad gives an array of integers and asks Harshit to find which three elements form a triangle
(non-degenerate). The task seems easy to Harshit.
