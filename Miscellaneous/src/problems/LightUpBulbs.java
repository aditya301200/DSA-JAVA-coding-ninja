...
/*
Problem Statement: Light Up the Bulbs
...
if the bulb is ‘ON’, make it ‘OFF’ and if it is ‘OFF’, make it ‘ON’. E.g. “0  011  001” -> “0  100  001”.
...
Input Format:
The first line will contain three space separated integers: ‘n’, ‘X’, ‘Y’ denoting the number of bulbs,
cost of first operation and cost of second operation respectively.
The second line contains a representation string of length ‘n’ consisting of 0’s and 1’s
...
public class LightUpBulbs {
    public static void main(String[] args) {
        ...
        //(num-1)*x = cost of reverse operations required to get one continuous segment + 1*y (cost of lighting up that 1 segment)
        int cost = Math.min(num*y, ((num-1)*x)+y);
        System.out.println(num);
